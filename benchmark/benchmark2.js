...
const hashmapImplementations = {
    'mootable-hashmap': {location: '../src/', esm: true},
    'map': {location: './nativeMap.js', esm: false},
...
function writeToFile() {
    ...
    table = table + "</tbody>\n</table>\n";
    fs.writeFile(`Benchmarks.${currentRun}.md`, table, function (err) {
        if (err) return console.log(err);
        console.log(`Written > Benchmarks.${currentRun}.md`);
    });
}
