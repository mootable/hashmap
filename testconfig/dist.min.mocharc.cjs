process.env.UNDER_TEST_NAME = process.env.UNDER_TEST_NAME ||  'browser-min';
process.env.UNDER_TEST_LOCATION = process.env.UNDER_TEST_LOCATION ||  'dist/hashmap.min.js';
